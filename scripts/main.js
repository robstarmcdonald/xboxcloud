...
var homePage = 'https://www.xbox.com/en-US/play/';
  ...
  async function createWindow() {
    ...
    if (process.argv.includes('--direct-start')) {
      mainWindow.loadURL('https://www.xbox.com/en-US/play/' + process.argv[process.argv.indexOf('--direct-start') + 1]);
    } else {
